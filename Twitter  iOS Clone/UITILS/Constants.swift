...
let ERICKELNINO_JACKPOT_LIKES_TWEET = ERICKLNINO_JACKPOT_DB_REF.child("Tweets-Likes")
let ERICKELNINO_JACKPOT_USER_TWEET_LIKES = ERICKLNINO_JACKPOT_DB_REF.child("Users-Likes")

let ERICKELNINO_JACKPOT_NOTIFICATION = ERICKLNINO_JACKPOT_DB_REF.child("Notification")
