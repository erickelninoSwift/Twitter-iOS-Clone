...
//  Twitter  iOS Clone
//
//  Created by Erick El nino on 2022/12/09.
...
class SearchProfileViewController: UICollectionViewController
{
    private let erickuser:UserDetails
    ...
    init(Myyuser: UserDetails , selctedTweet: TweetViewModel) {
